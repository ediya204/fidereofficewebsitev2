...
const content = {
  ...
  ar: {
    ...
    subtitle: "ترخيص TCSP والتسجيل كشركة ائتمان بموجب قانون الوصي (الفصل 29)",
    meta: {
      effectiveDate: "تاريخ السريان: 11 مايو 2026",
      version: "الإصدار: 1.1",
      owner: "مالك السياسة: إدارة الامتثال",
      contact: "التواصل: info@fideretrust.com",
      reviewCycle: "دورة المراجعة: سنوياً على الأقل أو عند طلب القانون/التنظيم",
    },
    documentControl: {
      title: "ضبط المستند",
      approver: "المعتمد: الإدارة المفوضة",
      nextReview: "تاريخ المراجعة التالية: 11 مايو 2027",
      changeLog: "سجل التغييرات: تحديث إفصاح تسجيل شركة الائتمان بموجب قانون الوصي (الفصل 29)",
    },
    sections: [
      {
        title: "1. معلومات الكيان القانوني",
        items: [
          "الكيان التشغيلي: FIDERE TRUST LIMITED.",
          "ولاية التسجيل: منطقة هونغ كونغ الإدارية الخاصة.",
          "المكتب المسجل: RM 32, 1/F, Kaiser Estate Phase 3, KT Hok Yuen Street, Hung Hom, Hong Kong.",
          "التواصل الرسمي: info@fideretrust.com | +852 5128 6593.",
        ],
      },
      {
        title: "2. حالة الترخيص والإشراف",
        items: [
          "رقم ترخيص مقدم خدمات الائتمان أو الشركات: TC010497.",
          "FIDERE TRUST LIMITED مسجلة كشركة ائتمان بموجب المادة 78(1) من قانون الوصي (الفصل 29) في هونغ كونغ.",
          "صدرت شهادة التسجيل كشركة ائتمان عن سجل الشركات في 11 مايو 2026.",
          "تؤكد الشهادة أن FIDERE TRUST LIMITED امتثلت لمتطلبات المادة 77 من قانون الوصي (الفصل 29) وتم تسجيلها كشركة ائتمان.",
          "سلطة التسجيل هي مسجل الشركات في منطقة هونغ كونغ الإدارية الخاصة.",
        ],
      },
      {
        title: "3. نطاق خدمات الائتمان والشركات",
        items: [
          "تُقدم خدمات الشركة ضمن إطار تشغيلي موجه للامتثال لإدارة الائتمانات والترتيبات الائتمانية وخدمات الشركات وإدارة العملاء ودعم معالجة الأموال ذات الصلة.",
          "تُقدم الخدمات وفق القوانين والمتطلبات التنظيمية المطبقة في الولايات القضائية المعنية.",
          "عندما يتطلب نوع خدمة أو شريحة عملاء أو إقليم ترخيصاً محدداً، تقدم الخدمات ضمن النطاق المسموح فقط.",
          "قد يختلف الوضع التنظيمي ونطاق الترخيص بحسب المنتج والموقع، وقد تطبق فحوص أهلية إضافية قبل فتح الحساب.",
        ],
      },
      {
        title: "4. النطاق المسموح والقيود",
        items: [
          "المعلومات على هذا الموقع عامة ولا تشكل مشورة قانونية أو ضريبية أو استثمارية.",
          "قد تكون بعض الحلول متاحة فقط للعملاء المؤهلين أو المحترفين بموجب القانون المطبق.",
          "يجوز لـ FIDERE رفض أو تقييد أو تعليق أو إنهاء الوصول إذا لم تتحقق شروط فتح الحساب أو الامتثال أو القانون.",
        ],
      },
      {
        title: "5. الولايات القضائية المقيدة",
        items: [
          "قد لا تكون الخدمات متاحة في الولايات الخاضعة للعقوبات أو القيود.",
          "يتحمل المستخدمون مسؤولية التأكد من قانونية الوصول إلى هذا الموقع واستخدامه في موقعهم.",
          "تحتفظ FIDERE بحق تحديث قيود الولايات ومعايير أهلية العملاء دون إشعار مسبق.",
        ],
      },
    ],
  },

...
export function TrustAccountTechnology() {
  ...
  const content = {
    ...
    ar: {
      label: "تقنيتنا",
      title: "مصممة للأمان والسرعة والتوسع",
      subtitle:
        "تجعل منصتنا المدعومة بواجهات API إدارة الأصول الائتمانية أسهل مع أمان وموثوقية على مستوى المؤسسات.",
      features: [
        {
          icon: Code,
          title: "تكامل بسيط",
          points: ["نموذج رسائل بيانات بسيط ومرن", "أسواق ونقاط نهاية متعددة عبر تكامل واحد", "واجهة RESTful API مع توثيق شامل"],
        },
        {
          icon: Headphones,
          title: "دعم عالمي 24/7",
          points: ["معالجة التحويلات فورياً", "الوصول إلى أسعار صرف تنافسية وفورية", "مراقبة وتقارير فورية"],
        },
        {
          icon: Shield,
          title: "توافر عال",
          points: ["توافر المنصة 99.9%", "مدعومة ببنية سحابية", "تعاف ذاتي مع تحويل تلقائي عند الأعطال"],
        },
        {
          icon: Zap,
          title: "عمليات مؤتمتة",
          points: ["تقليل عبء المعالجة اليدوية", "أتمتة التسويات والعمليات الخلفية", "مسارات امتثال مبسطة"],
        },
        {
          icon: Globe,
          title: "شبكة عالمية",
          points: ["الوصول إلى أكثر من 50 دولة", "دعم متعدد العملات", "تكامل مع قنوات الدفع المحلية"],
        },
        {
          icon: Clock,
          title: "سرعة الوصول إلى السوق",
          points: ["إصدارات ميزات منتظمة", "دون توقف للعملاء", "اختبارات وضمان جودة مؤتمتة"],
        },
      ],
    },
  }

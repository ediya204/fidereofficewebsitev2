...
const arSeo: Record<PageKey, SeoEntry> = {
  ...
  whiteLabel: {
    title: "خدمات العلامة البيضاء لشركات الائتمان | FIDERE TRUST",
    description:
      "حلول علامة بيضاء تساعد شركات الائتمان والمؤسسات المالية على تقديم خدمات ائتمانية تحت علامتها التجارية ببنية تحتية متكاملة.",
    keywords: ["علامة بيضاء ائتمانية", "بنية شركات الائتمان"],
  },
  trustAccount: {
    title: "حساب ائتماني | حساب ائتمان هونغ كونغ | FIDERE TRUST",
    description:
      "حساب ائتماني لإدارة الأصول عالمياً عبر بنية مرنة تجمع الحفظ، التقارير، المدفوعات، والامتثال.",
    keywords: ["حساب ائتماني", "حساب ائتمان هونغ كونغ"],
  },
  personalTrust: {
    title: "ائتمان عائلي | خدمات الائتمان الشخصي في هونغ كونغ | FIDERE TRUST",
    description:
      "خدمات ائتمان شخصي وعائلي لذوي الملاءة العالية تشمل تخطيط التعاقب، الحوكمة، وحماية الأصول.",
    keywords: ["ائتمان عائلي", "ائتمان شخصي", "حماية الأصول"],
  },
  wealthManagement: {
    title: "إدارة الأصول | إدارة ثروة قائمة على الائتمان | FIDERE TRUST",
    description:
      "حلول إدارة ثروة واستثمار قائمة على الحساب الائتماني للوصول إلى الأسواق العالمية وتخصيص الأصول متعدد العملات.",
    keywords: ["إدارة الأصول", "إدارة الثروة", "تخصيص أصول عالمي"],
  },
  familyOffice: {
    title: "مكتب العائلة | خدمات الائتمان العائلي في هونغ كونغ | FIDERE TRUST",
    description:
      "حلول مكتب عائلة تشمل الحوكمة العائلية، هيكلة الائتمان، تمكين الجيل القادم، وتخطيط الثروة متعددة الأجيال.",
    keywords: ["مكتب العائلة", "حوكمة العائلة", "تخطيط التعاقب"],
  },
  offshoreAccounts: {
    title: "حسابات ائتمانية خارجية | حماية أصول هونغ كونغ | FIDERE TRUST",
    description:
      "حسابات ائتمانية خارجية لدعم حماية الأصول، التنويع متعدد الولايات، وإدارة الثروة العالمية.",
    keywords: ["حساب ائتماني خارجي", "حماية أصول خارجية"],
  },
  corporateClients: {
    title: "خدمات ائتمان الشركات | حلول وصي هونغ كونغ | FIDERE TRUST",
    description:
      "خدمات ائتمان وشركات للعملاء المؤسسيين تشمل التأسيس، الامتثال، دعم المعاملات، وخدمات الحفظ.",
    keywords: ["ائتمان الشركات", "وصي مؤسسي", "امتثال الشركات"],
  },
  globalInvoicePayment: {
    title: "دفع الفواتير العالمية | خدمات مدفوعات الحساب الائتماني | FIDERE TRUST",
    description:
      "خدمة دفع فواتير عالمية تتيح تفويض مدفوعات الفواتير العابرة للحدود ضمن مسارات عمل منظمة ومتعددة العملات.",
    keywords: ["دفع الفواتير العالمية", "مدفوعات الحساب الائتماني"],
  },
  complianceKyc: {
    title: "الامتثال و KYC | فتح حساب ائتمان هونغ كونغ | FIDERE TRUST",
    description:
      "إطار الامتثال و KYC/KYB لدى FIDERE TRUST، بما في ذلك العناية الواجبة، العقوبات، ومراقبة المخاطر المستمرة.",
    keywords: ["امتثال KYC", "فتح حساب KYB", "مكافحة غسل الأموال"],
  },
  regulatoryStatus: {
    title: "الوضع التنظيمي | قانون الوصي الفصل 29 | FIDERE TRUST",
    description:
      "معلومات ترخيص TCSP وتسجيل FIDERE TRUST LIMITED كشركة ائتمان في هونغ كونغ بموجب قانون الوصي.",
    keywords: ["ترخيص TCSP", "شركة ائتمان مسجلة"],
  },
  riskFees: {
    title: "المخاطر والرسوم | تكاليف خدمات الائتمان وإدارة الأصول | FIDERE TRUST",
    description:
      "إفصاحات المخاطر والرسوم ومبادئ التسعير ومعالجة الشكاوى المتعلقة بخدمات FIDERE TRUST.",
    keywords: ["إفصاح المخاطر", "رسوم الائتمان"],
  },
  kycGuide: {
    title: "دليل KYC للشركات | مستندات حساب ائتمان هونغ كونغ | FIDERE TRUST",
    description:
      "دليل فتح حساب الشركات ومتطلبات KYC و UBO والمستندات المطلوبة للحسابات الائتمانية المؤسسية.",
    keywords: ["دليل KYC للشركات", "معلومات UBO"],
  },
  personalKycGuide: {
    title: "دليل KYC الشخصي | مستندات حساب الائتمان العائلي | FIDERE TRUST",
    description:
      "دليل فتح حساب ائتماني شخصي يشرح خطوات التقديم ومتطلبات الهوية والعنوان والإقامة الضريبية.",
    keywords: ["KYC شخصي", "فتح حساب ائتماني شخصي"],
  },
  contact: {

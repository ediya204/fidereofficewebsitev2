...
const translations = {
  ...
  ar: {
    heroLabel: "مكتب العائلة",
    heroTitlePart1: "منصة مخصصة",
    heroTitleHighlight: "لحوكمة مكتب العائلة",
    heroSubtitle: "نموذج منسق لإدارة ثروة متعددة الأجيال",
    heroDescription:
      "ندمج هيكلة الائتمان، الحفظ، المدفوعات، والتقارير ضمن نموذج تشغيل منسق مصمم للعائلات متعددة الأجيال.",
    subNav: ["خدماتنا", "المزايا", "تواصل معنا"],
    sectionLead:
      "نلتزم بمساعدة ثروة عائلتك على الصمود أمام الزمن. يدعم فريقنا الاستشاري التخطيط بين الأجيال باستراتيجيات منظمة وقابلة للتنفيذ.",
    serviceTitle: "خدماتنا الاستشارية للعائلات",
    serviceSubtitle: "منهج منظم من الاستشارة إلى التنفيذ.",
    serviceItems: [
      {
        title: "حوكمة العائلة",
        description:
          "نساعد في إعداد ميثاق العائلة وتصميم المجلس ومنتديات القرار، لتأسيس توافق واضح بين الأجيال. كما نيسر الاجتماعات العائلية ونحدد بروتوكولات التواصل ونحول القيم إلى قواعد حوكمة عملية طويلة الأجل.",
        image:
          "https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=1200&q=80",
      },
      {
        title: "بنية مكتب العائلة",
        description:
          "ندعم تأسيس ومراجعة نماذج مكتب العائلة الواحد من حيث الاستراتيجية ونطاق الخدمة والموقع والتكلفة والكوادر والحوكمة، مع توصيات تنفيذ مرحلية تناسب تعقيد العائلة وانتشارها القضائي.",
        image:
          "https://images.unsplash.com/photo-1467269204594-9661b134dd2b?auto=format&fit=crop&w=1200&q=80",
      },
      {
        title: "تمكين الجيل القادم",
        description:
          "نؤهل أفراد الجيل القادم عبر برامج تعليمية وحوار موجه حول القيادة والثقة المالية والمسؤولية. يجمع المنهج بين ورش السيناريو ومسارات المشاركة في الحوكمة وتخطيط الجاهزية المرحلي.",
        image:
          "https://images.unsplash.com/photo-1521737604893-d14cc237f11d?auto=format&fit=crop&w=1200&q=80",
      },
    ],
    advantageTitle: "مزايا استشاراتنا العائلية",
    advantageItems: [
      {
        title: "متخصصون مكرسون",
        description: "فريق استشاري متعدد التخصصات يغطي الحوكمة والهيكلة الائتمانية والتنفيذ متعدد الولايات.",
      },
      {
        title: "حوار منظم",
        description: "ورش حيادية ومنظمة لمواءمة أفراد العائلة حول القيم والأهداف وأولويات التنفيذ.",
      },
      {
        title: "مراجعة مستقلة",
        description: "تقييم مستقل للهياكل ونماذج الحوكمة القائمة لتحديد مسارات تحسين عملية.",
      },
      {
        title: "رؤى قابلة للتنفيذ",
        description: "تحويل التوصيات الاستراتيجية إلى خطط تنفيذ بمسؤوليات ومعالم تشغيلية واضحة.",
      },
    ],
    ciesTitle: "برنامج الوافدين للاستثمار الرأسمالي الجديد (CIES)",
    ciesDescription: "تعرف على كيفية دعم خدمات CIES لاحتياجات التخطيط العائلي والإقامة.",
    ciesButton: "اعرف المزيد",
    contactTitle: "تواصل معنا",
    contactDescription: "نعمل معك لتحقيق أهداف عائلتك.",
    contactPrimary: "تواصل معنا",
    contactSecondary: "رتب اتصالاً",
    disclaimerTitle: "قد يهمك أيضاً",
    disclaimerText:
      "قد يكون رأس مالك معرضاً للمخاطر. قد ترتفع قيمة الاستثمارات أو تنخفض، وقد لا تسترد المبلغ الأصلي المستثمر.",
  },
}

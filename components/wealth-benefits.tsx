...
const translations = {
  ...
  ar: {
    ...
    benefits: [
      { title: "لا ضريبة أرباح رأسمالية في هونغ كونغ", description: "عزز عوائدك الاستثمارية في بيئة بلا ضريبة أرباح رأسمالية." },
      { title: "فتح حساب سريع", description: "ابدأ رحلة الاستثمار بسرعة عبر عملية فتح حساب مبسطة." },
      { title: "وصول عالمي 24/7", description: "ادخل إلى الأسواق العالمية في أي وقت لفرص استثمارية ديناميكية." },
      { title: "لا متطلبات حد أدنى مرتفعة", description: "استثمر دون تكاليف عالية أو رسوم مخفية، مما يجعل المشاركة أكثر سهولة." },
      { title: "لا حاجة للحضور الشخصي", description: "افتح حسابك عن بعد دون الحاجة إلى زيارة شخصية." },
    ],
  },
}

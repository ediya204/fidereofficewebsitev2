...
const translations = {
  ...
  ar: {
    title: "شريك حلول موثوق لأعمالك وثروتك",
    categories: ["حلول الائتمان والحفظ", "الحلول المالية", "حلول الأعمال"],
    notice:
      "تنبيه: بعض خدماتنا متاحة حصراً للمستثمرين المحترفين كما هو محدد بموجب قانون الأوراق المالية والعقود الآجلة في هونغ كونغ (الفصل 571). إذا لم تكن مؤهلاً كمستثمر محترف، يرجى عدم الوصول إلى الخدمات المقيدة.",
  },
}

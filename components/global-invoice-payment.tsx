...
const translations = {
  ...
  ar: {
    sectionLabel: "دفع الفواتير العالمية",
    title: "فواتيرك، مسؤوليتنا",
    subtitle:
      "مع حساب FIDERE Trust، يمكنك تفويضنا بإدارة مدفوعات الفواتير المتعبة. تعمل خدمة دفع الفواتير العالمية كسكرتيرك الخاص، لتتمكن من توجيهنا لدفع أنواع مختلفة من الفواتير في أي وقت.",
    howItWorks: {
      label: "آلية العمل",
      title: "نقرة واحدة، كل الفواتير مدفوعة",
      steps: [
        {
          icon: "upload",
          title: "ارفع الفاتورة",
          description: "التقط صورة أو ارفع نسخة ممسوحة من الفاتورة عبر منصتنا.",
        },
        {
          icon: "fileCheck",
          title: "قدم تعليمات الدفع",
          description: "أدخل تفاصيل الدفع والتعليمات المطلوبة.",
        },
        {
          icon: "clock",
          title: "نتولى الباقي",
          description: "يعالج فريقنا الدفع نيابة عنك لضمان إتمامه بدقة وفي الوقت المناسب.",
        },
      ],
    },
    benefits: {
      label: "المزايا الرئيسية",
      title: "اختبر مزايا FIDERE Trust",
      items: [
        {
          icon: "fileCheck",
          title: "بدون عناء",
          description: "إدارة جميع فواتيرك في مكان واحد لتوفير الوقت والجهد.",
        },
        {
          icon: "shield",
          title: "الأمان",
          description: "معلوماتك المالية آمنة بفضل تدابيرنا الأمنية القوية.",
        },
        {
          icon: "clock",
          title: "الموثوقية",
          description: "بصفتنا وصياً عليك، لدينا واجب قانوني لمعالجة مدفوعاتك بسرعة وأمان مع إعطاء الأولوية لمصالح المستفيدين.",
        },
        {
          icon: "upload",
          title: "دعم جميع أنواع الفواتير",
          description: "من الإيجار والمرافق إلى الرسوم الدراسية الخارجية وأقساط التأمين، تغطي خدمتنا احتياجات الدفع الخاصة بك.",
        },
        {
          icon: "globe",
          title: "انتشار عالمي",
          description: "ادفع الفواتير بعدة عملات وعبر بلدان متعددة.",
        },
        {
          icon: "calendar",
          title: "مدفوعات مجدولة",
          description: "سواء أردت الدفع أسبوعياً أو شهرياً أو سنوياً، تتيح لك منصتنا إعداد مدفوعات تلقائية تناسب جدولك.",
        },
      ],
    },
  },

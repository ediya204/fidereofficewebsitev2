...
import { Building2, FileText, Users, Calculator, Scale, Briefcase } from "@/components/ui/app-icon"
...
const translations = {
  ...
  ar: {
    sectionLabel: "عملاء الشركات",
    title: "الخدمات التي نقدمها",
    subtitle: "حلول مؤسسية شاملة مصممة للأعمال الدولية",
    services: [
      {
        icon: "building",
        title: "تأسيس الشركات",
        description: "ندعم الشركات الدولية في التأسيس والإدارة، مع خيارات ولايات قضائية عالمية وخدمات انتقال مؤسسي سلسة.",
      },
      {
        icon: "fileText",
        title: "دعم المعاملات",
        description: "ندير المعاملات العابرة للحدود ونعمل كسكرتير مدفوعات لضمان سلاسة دفع الفواتير وإجراءات الإدارة.",
      },
      {
        icon: "users",
        title: "الأوصياء والمديرون",
        description:
          "نقدم دعماً ائتمانياً يركز على الحوكمة، بما في ذلك استشارات مجلس الإدارة، إعداد أطر الحوكمة، ضوابط التفويض، وتنسيق الامتثال المستمر للكيانات العابرة للحدود.",
      },
      {
        icon: "calculator",
        title: "الامتثال الضريبي",
        description: "يوفر فريقنا خدمات المحاسبة والامتثال الضريبي للشركات الدولية، بما في ذلك الحسابات السنوية والتدقيق والإقرارات ودعم السلطات الضريبية.",
      },
      {
        icon: "scale",
        title: "الامتثال التنظيمي",
        description: "نقدم حلولاً قانونية وامتثالية شاملة لمساعدة العملاء على التعامل مع المتطلبات التنظيمية العالمية عبر ولايات متعددة.",
      },
      {
        icon: "briefcase",
        title: "خدمات حفظ الأسهم",
        description: "نوفر خدمات حفظ وإدارة وتسوية آمنة لاستثمارات العملاء في الأسهم عبر الأسواق العالمية.",
      },
    ],
  },
}
              ...
              language === "en"
                ...
                : language === "zh-CN"
                  ...
                  : language === "zh-TW"
                    ...
                    : `الوحدة ${String(index + 1).padStart(2, "0")}`
            return (
              <div
                key={index}

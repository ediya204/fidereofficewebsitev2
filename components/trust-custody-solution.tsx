...
const translations = {
  ...
  ar: {
    sectionLabel: "الحل 01",
    title: "حلول الائتمان والحفظ",
    learnMore: "اعرف المزيد عن الائتمان ←",
    paragraph1:
      'وفقاً لقانون الاعتراف بالائتمانات (الفصل 76)، يشير مصطلح "الائتمان" إلى علاقة قانونية تنشأ عندما يضع المؤسس أصولاً تحت سيطرة وصي لصالح مستفيد أو لغرض محدد، سواء أثناء الحياة أو بعد الوفاة.',
    paragraph2:
      "سواء كان هدفك تخطيط الثروة والتعاقب، أو المزايا الضريبية، أو تراكم الأصول، أو مكتب العائلة، أو مزيداً من الخصوصية، يمكن لفريقنا تقديم المشورة بشأن هيكل الائتمان الأنسب لاحتياجاتك.",
    services: [
      {
        title: "خدمات الائتمان الخاص العالمية",
        description: "حلول ائتمانية شاملة لحماية الثروة وتخطيط الإرث.",
      },
      {
        title: "تحسين الاستثمار",
        description: "الوصول إلى فرص عالمية تتجاوز قنوات الاستثمار التقليدية.",
      },
      {
        title: "تخطيط التعاقب",
        description: "حماية إرثك ونقله بسلاسة عبر الأجيال.",
      },
      {
        title: "خدمات مكتب العائلة",
        description: "خدمات مصممة خصيصاً للعائلات ذات الملاءة العالية جداً.",
      },
    ],
  },
}

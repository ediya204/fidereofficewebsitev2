...
export function TrustAccountBenefits() {
  ...
  const content = {
    ...
    ar: {
      label: "مزايا منصتنا",
      title: "لماذا تختار حساب FIDERE الائتماني",
      subtitle:
        "توفر بنيتنا الائتمانية المرنة مزيداً من الأمان واليقين والشفافية والكفاءة، وهي متطلبات أساسية لإدارة الثروة الحديثة.",
      benefits: [
        {
          icon: Shield,
          title: "حماية الأصول",
          description: "هياكل قانونية قوية تحمي أصولك من المطالبات المحتملة وتمنحك راحة البال.",
        },
        {
          icon: Globe,
          title: "وصول عالمي",
          description: "إدارة أصولك والوصول إليها من أي مكان في العالم عبر منصتنا الرقمية.",
        },
        {
          icon: Zap,
          title: "السرعة والكفاءة",
          description: "تنفيذ المعاملات وإدارة المحفظة بسرعة وبساطة غير مسبوقة.",
        },
        {
          icon: Eye,
          title: "الشفافية",
          description: "رؤية فورية لأصولك ومعاملاتك وأدائك من خلال لوحة تحكم سهلة الاستخدام.",
        },
        {
          icon: Scale,
          title: "الامتثال",
          description: "مبنية على أساس قوي من الامتثال التنظيمي لتلبية المتطلبات القانونية.",
        },
        {
          icon: Lock,
          title: "الخصوصية",
          description: "ميزات خصوصية معززة لضمان سرية وأمان شؤونك المالية.",
        },
      ],
    },
  }

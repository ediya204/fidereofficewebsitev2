...
const translations = {
  ...
  ar: {
    title: "دليل فتح حساب ائتماني شخصي لدى FIDERE",
    subtitle:
      "يشرح هذا الدليل عملية فتح الحساب والمستندات المطلوبة ومتطلبات التحقق من الهوية لحسابات FIDERE الائتمانية الشخصية. تُستخدم جميع المعلومات المجمعة للوفاء بالالتزامات القانونية والامتثالية وحماية أصول العملاء.",
    accountSection: "1. وصف الحساب",
    accountDesc: "تُستخدم الحسابات الائتمانية الشخصية ضمن ترتيبات ائتمانية لمساعدة العملاء في:",
    accountPurposes: ["حفظ الأصول", "خدمات وإدارة الأصول", "ترتيبات حفظ أو إشراف", "حيازة استثمارية وإدارة أصول طويلة الأجل"],
    accountNote:
      "تقدم FIDERE خدمات الإدارة والدعم الامتثالي فقط ضمن هيكل الائتمان، ولا تعمل كمالك مستفيد للأصول أو مستخدم للأموال.",
    processSection: "2. نظرة عامة على عملية فتح الحساب",
    processDesc:
      "تتكون عملية فتح الحساب الائتماني الشخصي من 5 خطوات. يرجى تجهيز المستندات ذات الصلة قبل البدء لإكمال الطلب بسلاسة في جلسة واحدة.",
    stepsSection: "3. خطوات فتح الحساب والمعلومات المطلوبة",
    steps: [
      {
        number: 1,
        title: "المعلومات الشخصية",
        description: "تحتاج إلى تقديم معلومات الهوية الأساسية والخلفية الاقتصادية، بما في ذلك:",
        details: ["الاسم القانوني كما يظهر في وثيقة الهوية", "الاسم باللغة المحلية أو الاسم البديل إن وجد", "تاريخ ومكان الميلاد", "الجنسية، مع ذكر أي جنسية مزدوجة"],
        subSection: "كما يرجى تقديم:",
        subDetails: ["المهنة وصاحب العمل والمنصب", "غرض فتح الحساب مثل حفظ الأصول أو الاستثمار أو إدارة الائتمان", "مصدر الأموال مثل الراتب أو المدخرات أو عوائد الاستثمار أو بيع الأصول أو الإرث أو الهبات", "مصدر الثروة", "نطاق الدخل السنوي", "ما إذا كانت هناك ترتيبات تمويل من طرف ثالث"],
      },
      {
        number: 2,
        title: "بيانات الاتصال والعنوان السكني",
        description: "يرجى تقديم:",
        details: ["رقم هاتف محمول قادر على استقبال رموز التحقق", "العنوان السكني الفعلي الحالي، ولا تُقبل صناديق البريد"],
        addressNote: "يجب أن يتضمن العنوان: الشارع، المدينة/المنطقة، الرمز البريدي، والدولة.",
        proofNote: "في مرحلة المراجعة اللاحقة، ستحتاج إلى تقديم إثبات عنوان خلال آخر 3 أشهر، مثل فاتورة مرافق أو كشف حساب بنكي.",
      },
      {
        number: 3,
        title: "إقرار الإقامة الضريبية",
        description: "للامتثال لمتطلبات الضرائب الدولية، تحتاج إلى:",
        details: ["الإقرار بما إذا كنت مقيماً ضريبياً في هونغ كونغ", "تقديم رقم التعريف الضريبي إن وجد", "الإفصاح عن أي إقامة ضريبية في دول أو مناطق أخرى"],
        note: "يتم تحديد الإقامة الضريبية وفقاً لقوانين الضرائب المحلية وإرشادات OECD في كل ولاية قضائية.",
      },
      {
        number: 4,
        title: "التحقق من الهوية",
        description: "تحتاج إلى إكمال خطوات التحقق التالية:",
        details: ["رفع وثيقة هوية صالحة مثل جواز السفر أو بطاقة هوية حكومية", "إكمال التعرف على الوجه وفحص الحيوية"],
        note: "تُقدم هذه العملية بدعم من مزود تحقق هوية خارجي Sumsub لضمان صحة الهوية ومنع الاحتيال.",
      },
      {
        number: 5,
        title: "التأكيد والتقديم",
        description: "قبل تقديم الطلب، يرجى:",
        details: ["مراجعة المعلومات المدخلة بعناية", "تأكيد أن المعلومات صحيحة ودقيقة وكاملة", "تقديم طلب فتح الحساب وإكمال التفويض"],
        note: "سيدخل طلبك في عملية مراجعة الامتثال بعد التقديم.",
      },
    ],
    tipsSection: "4. ملاحظات مهمة",
    tipsDesc: "لضمان فتح الحساب بسلاسة، نوصي بما يلي:",
    tipsList: ["جهز وثيقة هوية صالحة مسبقاً", "جهز إثبات عنوان صادر خلال آخر 3 أشهر", "أكمل التحقق من الهوية في بيئة مضاءة جيداً", "استخدم اتصال إنترنت مستقراً", "حاول إكمال جميع خطوات فتح الحساب في وقت واحد"],
    complianceSection: "5. استخدام المعلومات وبيان الامتثال",
    complianceDesc: "تستخدم FIDERE معلومات العملاء فقط من أجل:",
    complianceList: ["تحديد هوية العميل والتحقق منها", "مراجعة مكافحة غسل الأموال والامتثال", "المراقبة المستمرة بموجب المتطلبات القانونية والتنظيمية"],
    complianceNote: "سيتم الحفاظ على سرية جميع معلومات العملاء وفقاً للقانون.",
  },
}
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
                          ...
                          {locale === "en" ? `Step ${step.number}: ` : locale === "ar" ? `الخطوة ${step.number}: ` : `步骤${step.number}：`}
                          {step.title}
                        </h3>
                      </div>
                    </div>

...
export function TrustAccountHero() {
  ...
  const content = {
    ...
    ar: {
      label: "حساب ائتماني",
      title: "تبسيط إدارة الأصول الائتمانية عالمياً",
      subtitle:
        "تزيل منصتنا الائتمانية الشاملة التعقيد من إدارة الثروة، وتساعدك على إدارة الأصول عالمياً بمزيد من الأمان والشفافية والامتثال من خلال حساب واحد.",
      cta1: "ابدأ الآن",
      cta2: "تواصل معنا",
    },
  }

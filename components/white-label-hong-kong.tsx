...
const content = {
  ...
  ar: {
    title: "لماذا تأسيس شركة ائتمان في هونغ كونغ؟",
    subtitle: "هونغ كونغ موقع مثالي لتأسيس شركة ائتمان",
    features: [
      {
        icon: Globe,
        title: "الوصول إلى آسيا",
        description:
          "بصفتها أحد المراكز المالية الرائدة عالمياً، توفر هونغ كونغ قاعدة استراتيجية لتوسيع أعمالك عبر آسيا والمحيط الهادئ وما بعدها، كبوابة إلى أسواق عالية النمو.",
      },
      {
        icon: Shield,
        title: "أمان الأموال",
        description:
          "تتمتع هونغ كونغ ببنية مالية قوية ومستقرة سياسياً، وتُدار الأموال ضمن رقابة تنظيمية صارمة وأنظمة مصرفية عالمية.",
      },
      {
        icon: Landmark,
        title: "نظام القانون العام",
        description:
          "يعتمد الإطار القانوني في هونغ كونغ على القانون العام الإنجليزي، مما يوفر بيئة مألوفة وموثوقة للأعمال الدولية مع حماية قوية لحقوق الملكية.",
      },
      {
        icon: Scale,
        title: "كفاءة ضريبية",
        description:
          "توفر هونغ كونغ نظاماً ضريبياً تنافسياً بلا ضريبة أرباح رأسمالية أو ضريبة حجز على الأرباح، مع نظام إقليمي يفيد الهياكل الدولية.",
      },
      {
        icon: FileCheck,
        title: "تميز تنظيمي",
        description:
          "يوفر قانون شركات الائتمان إطاراً تنظيمياً واضحاً، بينما يضمن نظام ترخيص TCSP معايير مهنية عالية وحماية للعملاء.",
      },
      {
        icon: Building2,
        title: "بنية تحتية عالمية",
        description:
          "الوصول إلى بنوك عالمية رائدة ومقدمي خدمات محترفين وبنية مالية متقدمة يدعم عمليات الائتمان المعقدة بكفاءة.",
      },
    ],
  },
}

...
const translations = {
  ...
  ar: {
    ...
    faqs: [
      {
        question: "كيف أبدأ استخدام منصة إدارة الثروة لدى FIDERE TRUST؟",
        answer:
          "أنشئ حساب FIDERE TRUST عبر تقديم إثبات الهوية وإثبات العنوان وصورة شخصية. بعد الموافقة خلال بضعة أيام عمل، يمكنك تمويل الحساب وبدء الاستثمار.",
      },
      {
        question: "هل يوجد حد أدنى للاستثمار؟",
        answer: "لا تضع FIDERE TRUST حدوداً مرتفعة أو متطلبات حد أدنى للاستثمار، مما يتيح مشاركة أوسع للمستثمرين.",
      },
      {
        question: "كيف أدير استثماراتي عبر FIDERE TRUST؟",
        answer: "توفر منصتنا وصولاً عالمياً على مدار الساعة، بما يتيح إدارة محفظتك وتحسينها في أي وقت ومن أي مكان.",
      },
      {
        question: "هل أصولي آمنة مع FIDERE TRUST؟",
        answer:
          "الأمان والثقة من أولوياتنا. بصفتنا أوصياء وحفظة للملكية القانونية، تُحتفظ الأصول لدى مؤسسات مالية مرخصة أو أمناء حفظ من الدرجة الأولى.",
      },
      {
        question: "ما الالتزامات القانونية التي تحكم عمل FIDERE TRUST؟",
        answer:
          "يلزم قانون الوصي (الفصل 29) الأوصياء بممارسة العناية والمهارة المعقولتين وفقاً للظروف، كما يحدد مسؤوليات موظفي شركات الائتمان أمام المحكمة.",
      },
    ],
  },
}

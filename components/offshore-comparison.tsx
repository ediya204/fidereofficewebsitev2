...
const translations = {
  ...
  ar: {
    label: "مقارنة",
    title: "الحساب الائتماني مقابل الحساب المصرفي",
    subtitle: "اكتشف لماذا يوفر الحساب الائتماني مزايا أقوى لحماية الثروة.",
    trustAccount: "حساب ائتماني",
    bankAccount: "حساب مصرفي",
    rows: [
      { category: "الملكية القانونية", trust: "الوصي (شركة ائتمان)", bank: "البنك" },
      { category: "السرية", trust: "مرتفعة. الائتمان ترتيب سري.", bank: "منخفضة. قد تطلع عليه الجهات القضائية." },
      { category: "الاستقلالية", trust: "مرتفعة. ينفذ تعليمات المؤسس فقط.", bank: "منخفضة. قد تستخدم البنوك الودائع للإقراض." },
      { category: "عزل المخاطر", trust: "لا يجمّد أصول العميل.", bank: "قد تُجمّد الحسابات لأسباب متعددة." },
      { category: "الاستمرارية", trust: "دائمة. يمكن للائتمانات أن تستمر بلا أجل محدد.", bank: "محدودة. قد يتجمّد الحساب عند وقوع أحداث طارئة." },
      { category: "الخصوصية", trust: "مرتفعة. عادة لا يطلب الوصول إلا بأمر من المحكمة العليا.", bank: "منخفضة. يمكن الاستعلام عند وجود سبب." },
      { category: "المرونة", trust: "يقبل النقد والعقارات والمعادن.", bank: "يركز أساساً على النقد." },
    ],
  },
}

...
const translations = {
  ...
  ar: {
    ...
    titlePart1: "نوّع ثروتك",
    titleHighlight: "عالمياً",
    subtitle: "حماية الأصول من خلال حسابات ائتمانية متعددة الولايات القضائية",
    description:
      "احم أصولك من عدم الاستقرار الإقليمي والاضطرابات السياسية. احتفظ بعدة عملات واستفد من خدمات إدارة العملات على مدار الساعة.",
  },
}

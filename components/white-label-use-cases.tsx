...
const content = {
  ...
  ar: {
    title: "حلول العلامة البيضاء لدينا مناسبة لـ",
    case1: {
      number: "01",
      title: "المجموعات المالية الكبيرة",
      subtitle: "إدارة أصول مالية متنوعة، بما في ذلك الحيازات التقليدية وفئات الأصول الجديدة",
      benefits: [
        {
          icon: Users,
          text: "يستفيد العملاء من منصتنا الرقمية للائتمان، مما يسهل الاشتراك في عروضك مع التمتع بمزايا الخصوصية والحماية والتخطيط الضريبي والتعاقب التي يوفرها الائتمان.",
        },
        {
          icon: Briefcase,
          text: "يعزز ذلك فرص البيع والبيع الإضافي، ويدعم توسيع نطاق أعمالك وإيراداتها. كما تمنحك حلول الائتمان المصممة مرونة أكبر لخدمة احتياجات العملاء الفريدة.",
        },
        {
          icon: Key,
          text: "من خلال امتلاك شركة ائتمان خاصة بك لحفظ أموال العملاء، تحصل على تحكم كامل في عمليات KYC بدلاً من الاعتماد على قيود خارجية، مع القدرة على حوكمة الخزينة.",
        },
      ],
    },
    case2: {
      number: "02",
      title: "الشركات العائلية فائقة الملاءة",
      subtitle:
        "العائلات التي تسعى إلى حوكمة أصول الخزينة بشكل مستقل مع تعظيم الحماية عبر هيكل ائتماني ذاتي التحكم",
      benefits: [
        {
          icon: Shield,
          text: "دمج الأسهم والحيازات الأخرى ضمن كيان مدار داخلياً، بما يوفر عزل أصول متقدم وخصوصية وكفاءة ضريبية وتخطيطاً للتعاقب.",
        },
        {
          icon: Key,
          text: "تقليل الاعتماد على الأطراف الثالثة يزيد الملكية والاستقلالية على الأصول المهمة، ويخفض مخاطر القيود الخارجية وتسرب المعلومات.",
        },
        {
          icon: Scale,
          text: "تصميم حلول ائتمانية لاحتياجات العائلة وأهدافها يدعم حفظ الثروة عبر الأجيال، بينما تسهل الإدارة المهنية العمل الخيري ونقل الملكية وتخطيط الإرث.",
        },
      ],
    },
  },

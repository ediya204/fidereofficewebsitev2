...
const content = {
  ...
  ar: {
    title: "فتح حساب شركة",
    subtitle: "معلومات KYC و UBO المطلوبة",
    intro:
      "لإكمال فتح حساب الشركة والعناية الواجبة للامتثال، تطلب المنصة من العملاء المؤسسيين والأفراد المرتبطين بهم تقديم المعلومات والمستندات التالية قبل تفعيل الحساب.",
    sections: [
      {
        title: "1. المعلومات الأساسية للشركة",
        items: ["الاسم القانوني للكيان", "رقم تسجيل الشركة", "تاريخ التأسيس", "بلد / ولاية التأسيس", "العنوان المسجل، بما في ذلك:", "  • الشارع", "  • المدينة", "  • الولاية / المقاطعة", "  • الرمز البريدي"],
      },
      {
        title: "2. معلومات الاتصال بالشركة",
        items: ["رقم هاتف الشركة", "البريد الإلكتروني الرسمي للشركة"],
      },
      {
        title: "3. المستندات القانونية والتشغيلية للشركة",
        intro: "يجب على الشركة تقديم:",
        items: ["شهادة التأسيس و/أو التسجيل التجاري", "النظام الأساسي أو عقد التأسيس", "سجل المديرين والمساهمين", "قرار مجلس الإدارة الذي يجيز فتح الحساب وتعيين الممثل المفوض", "وصف طبيعة النشاط", "العنوان البريدي", "إثبات عنوان الشركة"],
      },
      {
        title: "4. مصدر الأموال ومصدر الثروة",
        subsections: [
          {
            subtitle: "مصدر الأموال (يمكن اختيار أكثر من خيار)",
            items: ["إيرادات الأعمال", "ضخ من المساهمين", "عوائد الاستثمار", "بيع الأصول", "قروض / تمويل", "منح حكومية", "أخرى"],
          },
          {
            subtitle: "مصدر الثروة (يمكن اختيار أكثر من خيار)",
            items: ["أرباح تشغيلية", "استثمار رأسمالي", "ارتفاع قيمة الأصول", "إرث / هبة", "أخرى"],
          },
          {
            subtitle: "نطاق الإيرادات السنوية",
            items: ["أقل من 1,000,000 دولار أمريكي", "1,000,000 – 10,000,000 دولار أمريكي", "10,000,000 – 50,000,000 دولار أمريكي", "50,000,000 – 100,000,000 دولار أمريكي", "أكثر من 100,000,000 دولار أمريكي"],
          },
        ],
        extra: "وصف سردي للأنشطة التجارية الرئيسية",
      },
      {
        title: "5. إقرارات الامتثال",
        intro: "يجب على الشركة الإفصاح عما يلي:",
        items: ["ما إذا كان الكيان خاضعاً لعقوبات أمريكية أو دولية أخرى", "ما إذا كان أي مساهم أو فرد رئيسي شخصاً سياسياً معرضاً للمخاطر (PEP)", "ما إذا كان أي فرد قريباً أو مرتبطاً بشخص PEP", "ما إذا كان الكيان يحتفظ بسياسات AML/KYC أو يخضع للتنظيم", "دليل مكافحة غسل الأموال، إن وجد", "غرض فتح الحساب"],
      },
      {
        title: "6. الممثل المفوض",
        intro: "يجب على الشركة تعيين ممثل مفوض وتقديم:",
        subsections: [
          { subtitle: "المعلومات الشخصية", items: ["الجنسية", "الجنس", "الاسم القانوني الكامل", "تاريخ الميلاد"] },
          { subtitle: "وثائق الهوية", items: ["نوع الهوية", "رقم الهوية", "تاريخ الإصدار", "تاريخ الانتهاء", "نسخة من وثيقة الهوية (الوجه الأمامي)"] },
          { subtitle: "المنصب وبيانات الاتصال", items: ["المنصب في الشركة", "رقم الهاتف المحمول", "البريد الإلكتروني"] },
          { subtitle: "العنوان السكني", items: ["الدولة", "الشارع", "المدينة", "الولاية / المقاطعة", "الرمز البريدي", "إثبات العنوان"] },
        ],
      },
      {
        title: "7. المديرون",
        intro: "يجب على الشركة تقديم معلومات جميع المديرين، بما في ذلك:",
        items: ["اسم المدير", "صفة المدير مثل الرئيس أو المدير"],
      },
      {
        title: "8. المستفيدون الحقيقيون النهائيون (UBO)",
        definition:
          "يشير UBO إلى أي شخص طبيعي يمتلك بشكل مباشر أو غير مباشر 20% أو أكثر من الشركة، أو يمارس السيطرة النهائية عليها بأي طريقة أخرى.",
        intro: "تشمل معلومات UBO المطلوبة:",
        subsections: [
          { subtitle: "المعلومات الشخصية", items: ["الجنسية", "الجنس", "اسم العائلة (بالإنجليزية / النقل الصوتي)", "الاسم الأول (بالإنجليزية / النقل الصوتي)", "تاريخ الميلاد"] },
          { subtitle: "وثائق الهوية", items: ["نوع الهوية", "رقم الهوية", "تاريخ الإصدار", "تاريخ الانتهاء", "نسخة من وثيقة الهوية (الوجه الأمامي)"] },
          { subtitle: "العلاقة بالشركة", items: ["مساهم / إدارة عليا / مسيطر نهائي", "المنصب إن وجد"] },
          { subtitle: "معلومات الاتصال", items: ["رقم الهاتف المحمول", "البريد الإلكتروني"] },
          { subtitle: "العنوان السكني", items: ["الدولة", "الشارع", "المدينة", "الولاية / المقاطعة", "الرمز البريدي", "إثبات العنوان"] },
        ],
      },
      {
        title: "9. PEP والعقوبات والمراقبة المستمرة للـ UBO",
        items: ["يخضع جميع المستفيدين الحقيقيين لفحص PEP والعقوبات", "قد تُطلب معلومات إضافية للمستفيدين المصنفين كـ PEP أو عاليي المخاطر", "خلال دورة حياة الحساب، قد تتطلب تغييرات معلومات UBO أو هيكل الملكية أو ملف المخاطر تحديث المعلومات"],
      },
      {
        title: "10. التأكيد الإلكتروني",
        items: ["يُكمل الممثل المفوض التوقيع الإلكتروني", "يؤكد التوقيع دقة واكتمال وصحة المعلومات المقدمة قانونياً"],
      },
    ],
  },
}

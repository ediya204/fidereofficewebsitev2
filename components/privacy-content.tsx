...
const translations = {
  ...
  ar: {
    ...
    lastUpdated: "آخر تحديث: 1 نوفمبر 2024",
    intro:
      "توضح سياسة الخصوصية هذه كيفية قيام FIDERE والشركات التابعة لها (ويشار إليها مجتمعة بـ \"نحن\") بجمع البيانات الشخصية واستخدامها والاحتفاظ بها والإفصاح عنها ونقلها وحمايتها، وذلك بما يتوافق مع متطلبات حماية البيانات الشخصية المعمول بها في هونغ كونغ.",
    sections: [
      {
        title: "1. التزامنا بالخصوصية",
        content:
          "نلتزم بإدارة البيانات الشخصية بطريقة تحافظ على الخصوصية والسرية والأمن. ولا نجمع إلا البيانات ذات الصلة واللازمة لتقديم خدماتنا ومنتجاتنا، ولا نستخدمها إلا للأغراض المحددة أو بموافقتك أو وفق ما يقتضيه القانون.\n\nنتخذ خطوات عملية لحماية البيانات الشخصية وضمان دقتها وعدم الاحتفاظ بها لمدة أطول من اللازم، ولا يحق الوصول إليها أو معالجتها إلا للأشخاص المخولين. كما يحق لك طلب الوصول إلى بياناتك الشخصية أو تصحيحها وفق القوانين المعمول بها.",
      },
      {
        title: "2. جمع البيانات الشخصية",
        content:
          "قد نجمع بياناتك الشخصية عندما تستخدم موقعنا أو تطبيقاتنا، أو تتواصل معنا، أو تتقدم بطلب للحصول على خدماتنا. وقد تتضمن هذه البيانات الاسم والعنوان ورقم الهاتف والبريد الإلكتروني والمعلومات المطلوبة لأغراض فتح الحساب أو الامتثال.\n\nقد نجمع أيضاً بيانات تقنية عند تصفحك للموقع، مثل عنوان IP ونوع المتصفح وإعدادات اللغة ونظام التشغيل ومدة الزيارة والصفحات التي تمت زيارتها، وذلك لتحليل الاستخدام وتحسين تجربة المستخدم وإدارة الموقع.",
      },
      {
        title: "3. استخدام البيانات الشخصية",
        content:
          "نستخدم بياناتك الشخصية لتقديم خدماتنا، معالجة طلباتك، تحسين الموقع والتطبيقات، الرد على الاستفسارات، إرسال إشعارات متعلقة بالخدمة، إجراء التحليلات والبحوث، الوفاء بالتزاماتنا التنظيمية والامتثالية، والقيام بأغراض مرتبطة مباشرة بما سبق.\n\nقد نستخدم بياناتك أيضاً لإبلاغك بخدمات أو منتجات أو تحديثات ذات صلة، وذلك بما يتوافق مع القوانين المعمول بها وخيارات الموافقة المتاحة لك.",
      },
      {
        title: "4. نقل البيانات الشخصية",
        content:
          "قد نشارك البيانات الشخصية مع مزودي الخدمات والشركاء والجهات الاستشارية أو التنظيمية عندما يكون ذلك ضرورياً لتقديم الخدمات أو الامتثال للقانون أو حماية حقوق FIDERE وعملائها. وقد يشمل ذلك مزودي الدفع والبريد الإلكتروني والدعم الإداري والامتثال.\n\nقد يتم نقل البيانات إلى شركات تابعة أو أطراف ذات صلة داخل هونغ كونغ أو خارجها، مع اتخاذ الضمانات المناسبة حيثما كان ذلك مطلوباً.",
      },
      {
        title: "5. التسويق المباشر",
        content:
          "قد نستخدم بيانات الاتصال لأغراض التسويق المباشر فقط وفق الحدود التي يسمح بها القانون وبناءً على موافقتك أو عدم اعتراضك حيثما يلزم. يمكنك سحب موافقتك أو تعديل تفضيلاتك في أي وقت عبر التواصل معنا على info@fideretrust.com.",
      },
      {
        title: "6. الأمن",
        content:
          "نطبق تدابير أمنية معقولة لحماية بياناتك الشخصية من الفقدان أو سوء الاستخدام أو الوصول غير المصرح به أو الإفصاح أو التعديل أو الإتلاف. ومع ذلك، لا يمكن ضمان أن تكون أي وسيلة نقل أو تخزين إلكترونية آمنة بالكامل.",
      },
      {
        title: "7. ملفات Cookie",
        content:
          "قد نستخدم ملفات Cookie وتقنيات مشابهة لتحسين الموقع، تذكر تفضيلاتك، فهم كيفية استخدام الزوار للموقع، ودعم وظائف معينة. يمكنك ضبط إعدادات المتصفح لقبول ملفات Cookie أو رفضها، لكن رفضها قد يؤثر في بعض وظائف الموقع.",
      },
      {
        title: "8. الروابط الخارجية",
        content:
          "قد يحتوي الموقع على روابط لمواقع خارجية. لا تخضع تلك المواقع لسياسة الخصوصية هذه، ولا نتحمل مسؤولية ممارسات الخصوصية أو المحتوى الخاص بها. ننصحك بمراجعة سياسات الخصوصية الخاصة بأي موقع خارجي تزوره.",
      },
      {
        title: "9. الاحتفاظ بالبيانات الشخصية",
        content:
          "نحتفظ بالبيانات الشخصية فقط للمدة اللازمة لتقديم الخدمات، تحقيق الأغراض التي جُمعت من أجلها، الوفاء بالتزاماتنا القانونية والتنظيمية، حل النزاعات، وإنفاذ اتفاقياتنا.",
      },
      {
        title: "10. حقوقك بشأن البيانات الشخصية",
        content:
          "قد يكون لك الحق في الوصول إلى بياناتك الشخصية أو تصحيحها أو طلب تقييد استخدامها أو الاعتراض على معالجتها، وفق القوانين المعمول بها. لممارسة هذه الحقوق، يرجى التواصل معنا عبر info@fideretrust.com. وقد نحتاج إلى التحقق من هويتك قبل معالجة الطلب.",
      },
      {
        title: "11. تعديل سياسة الخصوصية",
        content: "قد نقوم بتحديث سياسة الخصوصية هذه من وقت لآخر، ونشجعك على مراجعتها دورياً للاطلاع على أحدث نسخة.",
      },
      {
        title: "12. أولوية النسخة الإنجليزية",
        content: "في حال وجود أي تعارض أو غموض بين النسخة العربية والنسخة الإنجليزية من سياسة الخصوصية هذه، تسود النسخة الإنجليزية.",
      },
      {
        title: "13. الاستفسارات",
        content: "إذا كانت لديك أي أسئلة حول سياسة الخصوصية هذه، يرجى التواصل معنا عبر info@fideretrust.com.",
      },
    ],
  },
}

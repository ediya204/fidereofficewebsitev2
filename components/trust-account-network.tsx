...
export function TrustAccountNetwork() {
  ...
  const content = {
    ...
    ar: {
      label: "انتشار عالمي",
      title: "بوابتك إلى الأسواق العالمية",
      subtitle:
        "تخدم شبكتنا اليوم عملاء في آسيا والمحيط الهادئ وأوروبا وأمريكا الشمالية. نلتزم بجعل إدارة الثروة أكثر سهولة وكفاءة للجميع وفي كل مكان.",
      stats: [
        { value: "50+", label: "دولة نخدمها" },
        { value: "$10B+", label: "أصول تحت الائتمان" },
        { value: "24/7", label: "وصول إلى المنصة" },
        { value: "99.9%", label: "استمرارية التشغيل" },
      ],
      regions: ["آسيا والمحيط الهادئ", "أوروبا", "أمريكا الشمالية", "الشرق الأوسط"],
    },
  }

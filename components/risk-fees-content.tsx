...
const content = {
  ...
  ar: {
    title: "المخاطر والرسوم",
    subtitle: "إفصاحات المخاطر، مبادئ تسعير الخدمات، وآلية التعامل مع الشكاوى",
    meta: {
      effectiveDate: "تاريخ السريان: 1 أبريل 2026",
      version: "الإصدار: 1.0",
    ...
    documentControl: {
      ...
      nextReview: "تاريخ المراجعة التالية: 1 أبريل 2027",
      changeLog: "سجل التغييرات: الإصدار الأول",
    },
    sections: [
      {
        title: "1. إفصاح المخاطر",
        items: [
          "قد تنطوي الخدمات على مخاطر تنظيمية وتشغيلية وسوقية ومخاطر صرف وتسوية وطرف مقابل وتقنية.",
          "قد تخضع المعاملات العابرة للحدود لقيود قانونية محلية ومواعيد قطع ومعالجة وسيطة وتأخيرات تسوية.",
          "لا يشكل أي محتوى على هذا الموقع ضماناً للعوائد أو حماية لرأس المال أو مشورة استثمارية مخصصة.",
        ],
      },
      {
        title: "2. الرسوم والمصاريف",
        items: [
          "قد تشمل الرسوم المطبقة رسوم الخدمة والمعاملات والحفظ أو الإدارة ورسوم الأطراف الثالثة.",
          "قد تؤثر أسعار الصرف والفروقات والخصومات الوسيطة في مبالغ التسوية النهائية.",
          "تعتمد الرسوم الدقيقة على نوع الخدمة والولاية القضائية وتعقيد المعاملة ومتطلبات المؤسسة الشريكة.",
        ],
      },
      {
        title: "3. المدفوعات والإلغاء والاسترداد",
        items: [
          "تختلف أوقات المعالجة بحسب قناة الدفع والولاية وفحوص الامتثال ومواعيد قطع البنوك.",
          "قد تصبح بعض تعليمات الدفع غير قابلة للإلغاء بعد قبولها من المؤسسات المعنية.",
          "تظل عمليات الاسترداد، حيثما كانت متاحة، خاضعة للقيود القانونية والتشغيلية وقيود الأطراف المقابلة.",
        ],
      },
      {
        title: "4. التعامل مع الشكاوى",
        items: [
          "يمكن للعملاء تقديم الشكاوى عبر info@fideretrust.com مع تفاصيل الحالة والمستندات الداعمة.",
          "تسعى FIDERE إلى تأكيد الاستلام ومعالجة الشكاوى خلال إطار زمني معقول.",
          "عند الاقتضاء، قد تُصعّد المسائل غير المحلولة وفق قنوات النزاع التنظيمية المطبقة.",
        ],
      },
    ],
  },

...
const translations = {
  ...
  ar: {
    ...
    faqs: [
      {
        question: "ما هي خدمة الحفظ الخارجية؟",
        answer:
          "توفر خدمة الحفظ الخارجية إدارة وحماية آمنة للأصول في ولاية قضائية أجنبية، وتساعد على تنويع المخاطر وتعزيز الخصوصية والأمان.",
      },
      {
        question: "ما فوائد الاحتفاظ بالأموال بعدة عملات؟",
        answer:
          "يساعد الاحتفاظ بعدة عملات على تنويع المحفظة وتقليل المخاطر وتعزيز الأمان المالي، كما يتيح الاستفادة من أسعار الصرف المناسبة وحماية الثروة من التقلبات الإقليمية.",
      },
      {
        question: "هل يوجد حد أدنى للتمويل عند فتح الحساب؟",
        answer:
          "لا، لا تفرض FIDERE TRUST حداً أدنى للتمويل عند فتح الحساب، مما يمنحك مرونة في بدء إدارة الثروة وفق احتياجاتك وأهدافك.",
      },
      {
        question: "ما مدى أمان أصولي لدى FIDERE TRUST؟",
        answer:
          "كسب ثقتك وضمان أمان أصولك من أولوياتنا. نعمل كأوصياء وحفظة للملكية القانونية، وتُحتفظ الأصول لدى مؤسسات مالية مرخصة أو أمناء حفظ من الدرجة الأولى.",
      },
    ],
  },
}

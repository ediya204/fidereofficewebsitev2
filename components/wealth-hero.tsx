...
const translations = {
  ...
  ar: {
    label: "إدارة الثروة",
    headline1: "وصول على مدار الساعة إلى",
    headline2: "الأسواق العالمية",
    subtitle: "استثمر في الأسواق العالمية بأسلوب أبسط",
    description:
      "اجمع استثماراتك تحت حساب ائتماني واحد، مع حماية أصولك من عدم الاستقرار الإقليمي والاضطرابات السياسية. حقق تنويعاً عالمياً عبر حيازات متعددة العملات وخدمات إدارة عملات على مدار الساعة.",
    cta: "ابدأ الآن",
  },
}

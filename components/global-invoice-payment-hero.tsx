...
const translations = {
  ...
  ar: {
    label: "دفع الفواتير العالمية",
    titlePart1: "فواتيرك،",
    titleHighlight: "مسؤوليتنا",
    subtitle: "فوّض المدفوعات المعقدة إلى فريق تنفيذ موثوق",
    description:
      "تعمل خدمة دفع الفواتير العالمية كسكرتير مدفوعات لك، وتساعدك على تسوية أنواع مختلفة من الفواتير عبر مسارات عمل منظمة وجاهزية عابرة للحدود.",
  },
}

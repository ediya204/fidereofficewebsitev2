...
export function TrustAccountPlatform() {
  ...
  const content = {
    ...
    ar: {
      label: "معاينة المنصة",
      title: "لوحة تحكم قوية بين يديك",
      subtitle:
        "تمنحك منصتنا الواضحة رؤية وتحكماً كاملين في أصولك الائتمانية. راقب الأرصدة، تتبع المعاملات، أدر الاستثمارات، واطلع على التقارير من واجهة واحدة.",
      features: [
        { title: "رصيد فوري", desc: "تتبع إجمالي أصولك بتحديثات مباشرة" },
        { title: "سجل المعاملات", desc: "رؤية كاملة لجميع التحركات" },
        { title: "تحليلات المحفظة", desc: "رؤى تفصيلية للأداء" },
        { title: "دعم متعدد العملات", desc: "إدارة الأصول عبر العملات" },
      ],
    },
  }

...
const translations = {
  ...
  ar: {
    label: "الائتمان الشخصي",
    titlePart1: "حلول ثروة",
    titleHighlight: "مصممة لذوي الملاءة العالية",
    subtitle: "هياكل متقدمة للتعاقب والحوكمة وحماية الأصول",
    description:
      "نقدم خدمات تخطيط التعاقب وحوكمة العائلة وحماية الأصول، إلى جانب دعم المعاملات وحلول هيكلة الثروة.",
  },
}

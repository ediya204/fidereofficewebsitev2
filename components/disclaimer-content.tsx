...
除另有規定外，任何更改或修改將在網站上公佈修訂內容後立即生效，而您在該時間後繼續使用網站，即表示接受該等更改或修改。您應該不時查看條款以及納入其中的任何政策和文件，以了解適用於您對網站之使用的條款及條件。條款將始終在頂部顯示「最後更新」日期。如果您不同意任何經修訂的條款，您必須停止使用本網站。如對條款有任何疑問，請給我們發電子郵件，地址為：info@fideretrust.com.`,
  ...
  ar: {
    ...
    intro: `مرحباً بك في موقع FIDERE Trust. تشير عبارات "نحن" و"لنا" و"خاصتنا" في شروط الاستخدام هذه إلى FIDERE Trust Limited وشركاتها الأم والتابعة والزميلة. وتشير كلمة "أنت" إلى أي مستخدم لهذا الموقع.

يرجى قراءة شروط الاستخدام بعناية قبل استخدام هذا الموقع. إذا كنت لا توافق على هذه الشروط، فيجب عليك عدم استخدام الموقع.

إن الوصول إلى الموقع أو استخدامه أو مجرد تصفحه يعني موافقتك على الالتزام القانوني بهذه الشروط وبكل السياسات والإرشادات المشار إليها فيها. تحتفظ FIDERE Trust بحق تعديل هذه الشروط أو سياسات الموقع في أي وقت وفق تقديرها. تسري التعديلات عند نشرها، ويُعد استمرارك في استخدام الموقع قبولاً لها. للاستفسارات، يرجى التواصل عبر info@fideretrust.com.`,
    sections: [
      {
        title: "1. سياسة الخصوصية",
        content:
          "يرجى الرجوع إلى سياسة الخصوصية الخاصة بـ FIDERE Trust لمعرفة كيفية جمع البيانات الشخصية التي قد تحدد هوية المستخدمين واستخدامها والإفصاح عنها. باستخدام الموقع، فإنك توافق على معالجة هذه البيانات وفق سياسة الخصوصية.",
      },
      {
        title: "2. بيانات التسجيل وأمان الحساب",
        content:
          "عند تسجيل حساب، توافق على تقديم معلومات دقيقة وحديثة وكاملة، والحفاظ على سرية كلمة المرور، وتحديث بياناتك عند الحاجة. أنت مسؤول عن جميع الأنشطة والتكاليف التي تتم من خلال حسابك.",
      },
      {
        title: "3. الملكية الفكرية",
        content:
          "جميع المعلومات والنصوص والصور والبرمجيات والمواد الأخرى المتاحة على الموقع مملوكة لنا أو مرخصة لنا، وتحميها حقوق النشر والعلامات التجارية والقوانين ذات الصلة. لا يجوز تعديل أو نشر أو إعادة توزيع أو استغلال أي محتوى دون إذن كتابي مسبق.",
      },
      {
        title: "4. الترخيص المحدود للمحتوى",
        content:
          "تمنحك FIDERE Trust ترخيصاً محدوداً وقابلاً للإلغاء وغير حصري للوصول إلى الموقع وعرض أجزاء من المحتوى ونسخها وطباعتها لاستخدامك الشخصي فقط، شريطة الالتزام بهذه الشروط وعدم إزالة إشعارات الملكية أو استخدام أدوات استخراج البيانات.",
      },
      {
        title: "5. تقديم خدمات موثوقة وآمنة",
        content:
          "نأخذ الأمان بجدية ونسعى إلى توفير بيئة موثوقة وآمنة، إلا أنه لا يوجد نظام آمن أو موثوق بالكامل. باستخدام الموقع، فإنك تقبل المخاطر الملازمة لاستخدام الإنترنت والتقنيات ذات الصلة.",
      },
      {
        title: "6. روابط المواقع الأخرى",
        content:
          "قد يحتوي الموقع على روابط لمواقع ومحتوى تابع لأطراف ثالثة. تستخدم هذه الروابط على مسؤوليتك الخاصة، ولا تعني الروابط اعتماد FIDERE Trust أو رعايتها أو ارتباطها بتلك المواقع أو المحتوى.",
      },
      {
        title: "7. إخلاء المسؤولية",
        content:
          "يُقدم هذا الموقع والمحتوى والخدمات على أساس 'كما هو' دون أي ضمانات صريحة أو ضمنية. لا تضمن FIDERE Trust دقة المحتوى أو اكتماله أو حداثته أو خلوه من الأخطاء أو الفيروسات أو المكونات الضارة.",
      },
      {
        title: "8. تحديد المسؤولية والتعويض",
        content:
          "تستخدم الموقع على مسؤوليتك الخاصة. إلى أقصى حد يسمح به القانون، لا تتحمل FIDERE Trust أو الأطراف المرتبطة بها مسؤولية أي أضرار مباشرة أو غير مباشرة أو خاصة أو تبعية تنشأ عن استخدام الموقع أو المحتوى.",
      },
      {
        title: "9. الإشعارات",
        content: "عند نشر إشعارات على هذا الموقع، سيتم وضعها في المناطق المناسبة. أنت مسؤول عن مراجعة الموقع بانتظام للاطلاع على الإشعارات.",
      },
      {
        title: "10. أحكام أخرى",
        content:
          "إذا اعتُبر أي حكم من هذه الشروط غير قانوني أو غير صالح أو غير قابل للتنفيذ، فلن يؤثر ذلك في صلاحية الأحكام المتبقية. تشكل هذه الشروط الاتفاق الكامل بينك وبين FIDERE Trust بشأن استخدام الموقع.",
      },
      {
        title: "11. الأسئلة والتعليقات",
        content: "إذا كانت لديك أسئلة حول هذه الشروط أو استخدام الموقع، يرجى التواصل معنا عبر info@fideretrust.com.",
      },
    ],
  },
}

...
const translations = {
  ...
  ar: {
    title: "نحن نبرع في حل المشكلات، لا في بيع المنتجات المالية.",
    description:
      "لطالما أعاقت اللوائح المعقدة وغير الواضحة حول العالم قدرة الأفراد والشركات على تحسين الأصول وحماية الثروة. لذلك نعمل على بناء وتنفيذ حلول عالمية عابرة للحدود.",
  },
}

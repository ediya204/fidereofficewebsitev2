...
const translations = {
  ...
  ar: {
    label: "عملاء الشركات",
    titlePart1: "بنية مؤسسية",
    titleHighlight: "عالمية",
    subtitle: "خدمات متكاملة للتأسيس والامتثال والعمليات العابرة للحدود",
    description:
      "ندعم أعمالك بإطار قابل للتوسع يجمع خدمات الائتمان والشركات والإدارة وتنفيذ الخزينة والامتثال التنظيمي عبر ولايات قضائية متعددة.",
  },
}

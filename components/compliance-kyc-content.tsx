...
const content = {
  ...
  ar: {
    title: "الامتثال و KYC/KYB",
    subtitle: "مكافحة غسل الأموال وتمويل الإرهاب، ضوابط العقوبات، معايير فتح الحساب، وحوكمة KYB المستمرة",
    meta: {
    ...
    sections: [
      ...
      {
        title: "3. حزمة KYB المعتادة للشركات",
        items: [
      ...
      {
        title: "4. العقوبات و PEP والمراجعة المستمرة",
        items: [
      ...
      {
        title: "5. محفزات EDD وقبول المخاطر",
        items: [
      ...
      {
        title: "6. التعاون الامتثالي وحفظ السجلات",
        items: [
